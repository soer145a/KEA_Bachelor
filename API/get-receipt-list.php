...
if(isset($_POST['firstDate']) && isset($_POST['secondDate'])){
    ...
    while ($oOrderRow = $oOrderResult->fetch_object()) {
        ...
        array_push($aReceiptsHtmlList,"<li><p class='section-paragraph product-card__text'>$sOrderDate <a href='customer-receipts/$sCustomerId-$oOrderRow->order_id.pdf' download='Mirtual Order $oOrderRow->order_id - $sOrderDateFileName'>Download</a></p></li>") ;
